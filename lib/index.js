...
module.exports = function(
  ...
  font = Object.assign(
    {
      name: 'Open Sans',
      path: path.join(__dirname, 'open-sans/OpenSans-Regular.ttf')
    },
    mapStrToObj(font, 'name')
  )
  ...
  let leftWidth = measureText(subject.text, font) | 0
  let rightWidth = measureText(status.text, font) | 0
